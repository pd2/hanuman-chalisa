...
let hanuman_chalisa,  eng_chalisa, awadhi_chalisa;
...
let num_guess, is_random, is_english, num_choices = 5; 
...
function startGame() {
  ...
  if (is_english == true) {
    hanuman_chalisa = eng_chalisa;
  } else {
    hanuman_chalisa = awadhi_chalisa;
  }
  if (is_random == true) {
